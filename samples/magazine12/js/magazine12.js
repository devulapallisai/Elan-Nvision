...
(function ($) {
    ...
    var sampleName = 'magazine12',
        samplePath = 'samples/magazine12/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine12 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine12 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine12').removeClass('animated').addClass('zoom-in');
                ...
                swipeLeft: function () {
                    ...
                    $('.magazine12').turn('next');

                },

                swipeRight: function () {

                    $('.magazine12').turn('previous');
