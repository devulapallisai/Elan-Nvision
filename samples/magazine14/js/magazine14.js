...
(function ($) {
    ...
    var sampleName = 'magazine14',
        samplePath = 'samples/magazine14/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine14 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine14 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine14').removeClass('animated').addClass('zoom-in');
                ...
                swipeLeft: function () {
                    ...
                    $('.magazine14').turn('next');

                },

                swipeRight: function () {

                    $('.magazine14').turn('previous');
