...
(function ($) {
    ...
    var sampleName = 'magazine15',
        samplePath = 'samples/magazine15/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine15 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine15 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine15').removeClass('animated').addClass('zoom-in');
                ...
                swipeLeft: function () {
                    ...
                    $('.magazine15').turn('next');

                },

                swipeRight: function () {

                    $('.magazine15').turn('previous');
