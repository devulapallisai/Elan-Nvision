...
(function ($) {
    ...
    var sampleName = 'magazine13',
        samplePath = 'samples/magazine13/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine13 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine13 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine13').removeClass('animated').addClass('zoom-in');
                ...
                swipeLeft: function () {
                    ...
                    $('.magazine13').turn('next');

                },

                swipeRight: function () {

                    $('.magazine13').turn('previous');
