...
(function ($) {
    ...
    var sampleName = 'magazine0',
        samplePath = 'samples/magazine0/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine0 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine0 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine0').removeClass('animated').addClass('zoom-in');
