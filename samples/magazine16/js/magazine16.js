...
(function ($) {
    ...
    var sampleName = 'magazine16',
        samplePath = 'samples/magazine16/';
    ...
    function loadPage(page) {
        ...
        var img = $('<img />');
        img.load(function () {
            var container = $('.magazine16 .p' + page);
            img.css({
                width: '100%',
                height: '100%'
            });
            img.appendTo($('.magazine16 .p' + page));
            ...
            when: {
                ...
                change: function (event, scale) {
                    ...
                    if (scale == 1) {
                        ...
                        $('.magazine16').removeClass('animated').addClass('zoom-in');
                ...
                swipeLeft: function () {
                    ...
                    $('.magazine16').turn('next');

                },

                swipeRight: function () {

                    $('.magazine16').turn('previous');
